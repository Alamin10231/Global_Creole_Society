...
const SignUpPage = () => {
  ...
  const Signup = useMutation({
    ...
    onError: (err) => {
      console.log("error", err.response.data || "Sign up failed");
    },
  });
  ...
  const handleSubmit = (e) => {
    ...
    const payLoad = {
      ...
      promotional_code: formData.promotionalCode,
      gender: formData.gender,
      date_of_birth: `${formData.birthYear}-${formData.birthMonth}-${formData.birthDate}`,
  ...
  return (
    <div className="min-h-screen  py-8 px-4">
      <div className="max-w-lg md:max-w-xl lg:max-w-2xl xl:max-w-4xl mx-auto  rounded-lg  p-6">
        <h1 className="text-5xl font-medium text-center text-gray-900 mb-8">
          Sign up for free
        </h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          {/* Submit Button */}
          <AuthButton text="Sign Up" type="submit" className="w-full " />
